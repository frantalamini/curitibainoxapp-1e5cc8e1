...
export default function TechnicianReimbursements() {
  const { technicianId, isLoading: isLoadingTechnician } =
    useCurrentTechnician();
  const { isAdmin, loading: isLoadingRole } = useUserRole();
  const { canCreate: canManageReimbursements } =
    useModulePermissions("reimbursements");
  ...
  const isLoading =
    isLoadingTechnician || isLoadingReimbursements || isLoadingRole;
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground">
                Esta funcionalidade está disponível apenas para técnicos e
                administradores.
              </p>
            </CardContent>
          </Card>
  ...
  return (
    <MainLayout>
      <div className="w-full max-w-[1400px] mr-auto pl-2 pr-6 sm:pl-3 sm:pr-8 lg:pl-4 lg:pr-10 py-6 space-y-6">
        <PageHeader
          title={isAdmin ? "Gestão de Reembolsos" : "Meus Reembolsos"}
        >
          {isAdmin && canManageReimbursements ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="border-yellow-500/30 bg-yellow-500/5">
              <CardContent className="py-4 text-center">
                ...
                <div className="text-xs text-muted-foreground">
                  {summary.countPending} solicitação(ões)
                </div>
              </CardContent>
            </Card>
            <Card className="border-blue-500/30 bg-blue-500/5">
              <CardContent className="py-4 text-center">
                ...
                <div className="text-xs text-muted-foreground">
                  {summary.countApproved} solicitação(ões)
                </div>
              </CardContent>
            </Card>
            <Card className="border-green-500/30 bg-green-500/5">
              <CardContent className="py-4 text-center">
                ...
                <div className="text-xs text-muted-foreground">
                  {summary.countPaid} solicitação(ões)
                </div>
              </CardContent>
            </Card>
          </div>
