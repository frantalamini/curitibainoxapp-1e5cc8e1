...
// Tabs removidos - modal agora só mostra detalhes
...
// FinanceiroTab movido para ServiceCallForm
              ...
              (hasTech || hasClient) && (
                <Card className="mt-4">
                  ...
                  <CardContent className="p-4 sm:p-5 pt-2 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    {(() => {
                      const imgUrl =
                        latestTech?.image_url ||
                        call.technician_signature_data ||
                        call.technician_signature_url;
                      const signedAt =
                        latestTech?.signed_at || call.technician_signature_date;
                      const signedBy =
                    ...
                    {(() => {
                      const imgUrl =
                        latestClient?.image_url ||
                        call.customer_signature_data ||
                        call.customer_signature_url;
                      const signedAt =
                        latestClient?.signed_at || call.customer_signature_date;
                      const signedBy =
              ...
              <Card className="mt-4 border-2 border-dashed border-orange-300 dark:border-orange-800">
                <CardHeader className="p-4 sm:p-5 pb-2 sm:pb-3">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                    Estas informações são visíveis apenas para administradores e
                    técnicos.
                  </p>
                </CardHeader>
                <CardContent className="p-4 sm:p-5 pt-2 space-y-4">
