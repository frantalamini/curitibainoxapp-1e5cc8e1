...
export function ManualIncludeModal({
  open,
  onOpenChange,
  ofxTransaction,
  onConfirm,
}: ManualIncludeModalProps) {
          ...
          <div className="space-y-4">
            <div className="p-3 bg-muted rounded-lg text-sm">
              ...
              <p className="text-muted-foreground text-xs mt-1">
                {ofxTransaction.date} •{" "}
                {formatCurrency(Math.abs(ofxTransaction.amount))} • {direction}
              </p>
            </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <br />
              <strong>
                {formatCurrency(Math.abs(ofxTransaction.amount))}
              </strong>{" "}
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleConfirmInclusion}>
              Sim, incluir
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
